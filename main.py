...
class NumApp:
    ...
    def run(self):
        ...
        while n < self.attempts:
            ...
            if user_num_input < self.highest and target < user_num_input:
                print('Your guess is above the answer')
            elif self.lowest < user_num_input and user_num_input < target:
...
if __name__ == '__main__':
    num_guess = NumApp(lowest=0, highest=50, n=5)
    num_guess.run()